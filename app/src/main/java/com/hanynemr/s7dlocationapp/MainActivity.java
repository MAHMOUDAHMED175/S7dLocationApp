...
public class MainActivity extends AppCompatActivity implements AirLocation.Callback {
    ...
    public void onSuccess(@NonNull ArrayList<Location> locations) {
        ...
        //show on map
        Intent a=new Intent(Intent.ACTION_VIEW, Uri.parse("geo:0,0?q="+latitude+","+longitude));
        Intent ae=new Intent(Intent.ACTION_VIEW, Uri.parse("geo:0,0?q=cairo+stadium+egypt"));
        startActivity(a);
